...
function auditStaticFiles() {
  ...
  assert(index.includes('value="it"') && index.includes('value="nl"'), 'Expanded language options are missing');
  ...
  assert(sw.includes('cloud-recall-lab-v7'), 'Service worker cache should be bumped to v7');
